  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center py-2 bg-[#FFFFFF] px-3 rounded-[40px]">
        ...
        <div className="login-links hidden md:block tracking-wider py-3">
          <Link href='/login' className="hover:text-[#544DF2]">Login</Link>
          <Link href='/dashboard' className="bg-[#544DF2] text-white px-[30px] py-3 rounded-[49px] ml-4 shadow-[inset_0px_4px_11.2px_0px_#FAFAFAA1]">
            Get started
          </Link>
        </div>
      </div>
