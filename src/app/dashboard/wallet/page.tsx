...
const page = () => {
  return (
    <div className='px-4 py-6 h-[400px]'>
      ...
      <button className='bg-[#544DF2] text-[14px] text-[#FFFFFF] px-4 py-1.5 rounded-[8px] right-0 hover:bg-[rgba(84,77,242,0.8)] shadow-[inset_0px_4px_11.2px_0px_#FAFAFAA1]'>
