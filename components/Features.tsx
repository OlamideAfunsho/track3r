  ...
  return (
    <div className='flex flex-col items-center mt-18 md:mt-24 pt-4 '>
        ...
        <div className='mt-32 text-center'>
            <h1 className='text-4xl md:text-5xl font-bold w-2xs md:w-3xl'><span className='text-[#929297]'>Everything</span> You Need to Stay on <span className='text-[#544DF2]'>Top of Your Bills</span></h1>
            <FeaturesCon />
        </div>
    </div>
  )
